      ...
      subConceptList: [
        {
          ...
          lastLearningDate: "2024-05-05",
        },
        {
          subConceptId: 102,
          subConceptType: "정수와 유리수",
          lastLearningDate: "2024-05-03",
        },
        {
          subConceptId: 103,
          subConceptType: "소인수분해",
          lastLearningDate: "2024-04-28",
        },
        {
          subConceptId: 104,
          subConceptType: "제곱근",
          lastLearningDate: "2024-04-25",
        },
      ],
    },
    {
      ...
      subConceptList: [
        {
          ...
          lastLearningDate: "2024-05-06",
        },
        {
          subConceptId: 202,
          subConceptType: "연립방정식",
          lastLearningDate: "2024-05-01",
        },
        {
          subConceptId: 203,
          subConceptType: "일차함수",
          lastLearningDate: "2024-04-29",
        },
        {
          subConceptId: 204,
          subConceptType: "이차방정식",
          lastLearningDate: "2024-04-27",
        },
      ],
    },
    {
      ...
      subConceptList: [
        {
          subConceptId: 301,
          subConceptType: "삼각형의 넓이",
          lastLearningDate: "2024-05-04",
        },
        {
          subConceptId: 302,
          subConceptType: "피타고라스 정리",
          lastLearningDate: "2024-04-30",
        },
        {
          subConceptId: 303,
          subConceptType: "원의 넓이",
          lastLearningDate: "2024-04-26",
        },
        {
          subConceptId: 304,
          subConceptType: "입체도형",
          lastLearningDate: "2024-04-22",
        },
      ],
    },
    {
      ...
      subConceptList: [
        ...
        {
          subConceptId: 403,
          subConceptType: "경우의 수",
          lastLearningDate: "2024-04-24",
        },
        {
          subConceptId: 404,
          subConceptType: "자료 정리",
          lastLearningDate: "2024-04-20",
        },
      ],
    },
  ],
  high: [
    {
      ...
      subConceptList: [
        {
          subConceptId: 501,
          subConceptType: "실수 체계",
          lastLearningDate: "2024-05-06",
        },
        {
          subConceptId: 502,
          subConceptType: "다항식 연산",
          lastLearningDate: "2024-05-04",
        },
        {
          subConceptId: 503,
    ...
    },
    {
      ...
      subConceptList: [
        {
          subConceptId: 801,
          subConceptType: "순열과 조합",
          lastLearningDate: "2024-05-04",
        },
        {
          subConceptId: 802,
          subConceptType: "확률 기본",
          lastLearningDate: "2024-05-01",
        },
        {
          subConceptId: 803,
          subConceptType: "이산확률분포",
          lastLearningDate: "2024-04-28",
        },
        {
          subConceptId: 804,
...
const CURRICULUM_DESCRIPTIONS = {
  middle: {
    "수와 연산":
      "자연수, 정수, 유리수, 실수, 소수, 분수, 소인수분해, 제곱근, 사칙연산, 수 체계 확장, 연산의 성질",
    "변화와 관계":
  ...
  middle: {
    "1": [
      ...
      },
      {
        ...
        topic: "도형과 측정",
        problem:
          "삼각형의 넓이를 구하는 공식을 이용하여 밑변이 6cm, 높이가 4cm인 삼각형의 넓이를 구하시오.",
        date: "2024-04-27",
        isCorrect: true,
      },
      {
  ...
  high: {
    "1": [
      ...
      },
      {
        ...
        topic: "집합",
        problem:
          "집합 A = {1, 2, 3, 4}, B = {3, 4, 5, 6}에 대하여 A ∩ B를 구하시오.",
        date: "2024-04-29",
        isCorrect: true,
      },
      {
    ...
    "2": [
      {
        ...
        topic: "행렬 연산",
        problem:
          "행렬 A = [[1, 2], [3, 4]]와 B = [[2, 0], [1, 3]]의 곱 AB를 구하시오.",
        date: "2024-04-25",
        isCorrect: false,
      },
      {
      ...
      },
      {
        ...
        topic: "이산확률분포",
        problem:
          "이항분포 B(10, 0.3)에서 확률변수 X가 3 이하일 확률을 구하시오.",
        date: "2024-05-01",
        isCorrect: false,
      },
    ],
    "3": [
      ...
      },
      {
        ...
        topic: "공간도형",
        problem:
          "정육면체의 대각선의 길이를 구하시오. 정육면체의 한 변의 길이는 2이다.",
        date: "2024-04-27",
        isCorrect: true,
      },
      {
      ...
      },
      {
        ...
        topic: "경제 모델링",
        problem:
          "수요함수 p = 100 - 2q와 공급함수 p = 20 + 3q에서 균형가격과 균형수량을 구하시오.",
        date: "2024-05-01",
        isCorrect: false,
      },
    ],
    ...
    "2": [
      {
        ...
        title: "연립방정식",
        description:
          "두 개 이상의 방정식을 동시에 만족하는 해를 구하는 방정식입니다.",
  ...
  high: {
    "1": [
      {
        ...
        title: "이차방정식",
        description:
          "미지수가 2제곱으로 표현된 방정식으로, ax² + bx + c = 0 형태를 가집니다.",
      ...
      },
      {
        ...
        title: "순열과 조합",
        description:
          "순서를 고려하여 나열하는 방법(순열)과 순서 없이 선택하는 방법(조합)입니다.",
    ...
    "2": [
      ...
      },
      {
        ...
        title: "이차곡선",
        description:
          "포물선, 타원, 쌍곡선과 같은 2차 방정식으로 표현되는 곡선입니다.",
    ...
    "3": [
      ...
      },
      {
        ...
        title: "선형대수",
        description:
          "벡터 공간, 선형 변환, 행렬 등을 연구하는 수학의 한 분야입니다.",
  ...
  high: {
    "1": [
      ...
      },
      {
        ...
        problems: [
          "집합 A = {1, 2, 3, 4}, B = {3, 4, 5, 6}에 대하여 A ∩ B와 A ∪ B를 구하시오.",
        ],
      },
    ],
    "2": [
      {
        ...
        problems: [
          "함수 f(x) = x³ - 3x²의 도함수를 구하시오.",
          "함수 f(x) = sin(x)의 도함수를 구하시오.",
        ],
      },
      {
        id: 8,
...
export function getTopicDescription(
  ...
  if (educationLevel === "middle") {
    return (
      CURRICULUM_DESCRIPTIONS.middle[
        topic as keyof typeof CURRICULUM_DESCRIPTIONS.middle
      ] || "설명이 없습니다."
    );
  } else {
    return (
      CURRICULUM_DESCRIPTIONS.high[
        topic as keyof typeof CURRICULUM_DESCRIPTIONS.high
      ] || "설명이 없습니다."
    );
  }
}
...
export function getCurriculumConcepts(
  educationLevel: EducationLevel,
  grade: Grade
): any[] {
...
// 모든 학년의 개념 데이터 가져오기
export function getAllCurriculumConcepts(
  educationLevel: EducationLevel
): any[] {
...
export function getRecentlyStudiedTopics(
  educationLevel: EducationLevel,
  grade: Grade
): string[] {
...
export function getAllRecentlyStudiedTopics(
  educationLevel: EducationLevel
): string[] {
  const allRecentTopics: string[] = [];

  for (const grade in MISTAKE_DATA[educationLevel]) {
    allRecentTopics.push(
      ...getRecentlyStudiedTopics(educationLevel, grade as Grade)
    );
  }
...
// 주제별 오답 가져오기
export function getMistakesByTopic(
  topic: string | null,
  educationLevel: EducationLevel,
  grade: Grade
): any[] {
...
// 모든 학년에서 주제별 오답 가져오기
export function getAllMistakesByTopic(
  topic: string | null,
  educationLevel: EducationLevel
): any[] {
...
// 주제별 오답률 계산하기
export function getTopicErrorRate(
  topic: string,
  educationLevel: EducationLevel,
  grade: Grade
): number {
  ...
  const incorrectCount = topicMistakes.filter(
    (mistake) => !mistake.isCorrect
  ).length;
...
export function getAllTopicErrorRate(
  topic: string,
  educationLevel: EducationLevel
): number {
  let totalProblems = 0;
  ...
  for (const grade in MISTAKE_DATA[educationLevel]) {
    ...
    incorrectCount += topicMistakes.filter(
      (mistake) => !mistake.isCorrect
    ).length;
  }
...
// 주제별 마지막 학습일 가져오기
export function getTopicLastStudyDate(
  topic: string,
  educationLevel: EducationLevel,
  grade: Grade
): string | null {
  ...
  return topicMistakes.sort(
    (a, b) => new Date(b.date).getTime() - new Date(a.date).getTime()
  )[0].date;
}

// 모든 학년에서 주제별 마지막 학습일 가져오기
export function getAllTopicLastStudyDate(
  topic: string,
  educationLevel: EducationLevel
): string | null {
  ...
  for (const grade in MISTAKE_DATA[educationLevel]) {
    const lastDate = getTopicLastStudyDate(
      topic,
      educationLevel,
      grade as Grade
    );
...
// 주제별 학습 횟수 가져오기
export function getTopicStudyCount(
  topic: string,
  educationLevel: EducationLevel,
  grade: Grade
): number {
...
export function getAllTopicStudyCount(
  topic: string,
  educationLevel: EducationLevel
): number {
  let count = 0;
...
// Add a function to check if a problem was correctly solved on retry (수정)
export function wasSolvedOnRetry(
  problemId: number,
  educationLevel: EducationLevel,
  grade: Grade
): boolean {
  ...
  // solvedOnRetry 프로퍼티가 없으므로 항상 false 반환하거나 다른 로직 구현
  return false;
}
