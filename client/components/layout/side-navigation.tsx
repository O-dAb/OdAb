...
import { Calculator, BookOpen, History, Home, Settings, Clock, User, HelpCircle } from "lucide-react"
    ...
    <div className="h-full bg-blue-50 border-r border-blue-100 w-20 flex flex-col items-center py-6">
      <div className="flex flex-col items-center gap-6">
        ...
        >
          ...
          <span className="text-xs font-medium">문제 업로드</span>
        </Button>
      ...
      <div className="mt-auto flex flex-col items-center gap-4">
        <Button
          ...
          className={cn(
            "w-14 h-14 rounded-xl flex flex-col justify-center items-center gap-1 hover:bg-blue-100",
            activeTab === "profile" && "bg-blue-100 text-blue-500",
          )}
        ...
        <Button
          ...
          className={cn(
            "w-14 h-14 rounded-xl flex flex-col justify-center items-center gap-1 hover:bg-blue-100",
            activeTab === "help" && "bg-blue-100 text-blue-500",
          )}
