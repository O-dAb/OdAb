...
export function SequentialProblemSolver({
  educationLevel,
  grade,
}: SequentialProblemSolverProps) {
        ...
        steps: [
          {
            title: "문제 이해하기",
            content:
              "이 문제는 이차방정식 x² - 5x + 6 = 0을 풀어 x의 값을 구하는 문제입니다.",
            hint: "이차방정식의 표준형은 ax² + bx + c = 0 입니다. 여기서 a = 1, b = -5, c = 6 입니다.",
          },
          {
            title: "해결 방법 선택하기",
            content:
              "이차방정식을 풀기 위한 여러 방법 중 인수분해를 사용해 보겠습니다.",
          ...
          },
          {
            title: "해 구하기",
            content:
              "(x-2)(x-3) = 0이므로, x-2 = 0 또는 x-3 = 0입니다. 따라서 x = 2 또는 x = 3입니다.",
        ...
        steps: [
          {
            title: "문제 이해하기",
            content:
              "이 문제는 이차방정식 2x² - 7x + 3 = 0을 풀어 x의 값을 구하는 문제입니다.",
            hint: "이차방정식의 표준형은 ax² + bx + c = 0 입니다. 여기서 a = 2, b = -7, c = 3 입니다.",
          },
          {
            title: "해결 방법 선택하기",
            content:
              "이 방정식은 인수분해가 쉽지 않아 보입니다. 근의 공식을 사용해 보겠습니다.",
          ...
          },
          {
            title: "해 구하기",
            content:
              "x = (7 + 5) / 4 = 12 / 4 = 3 또는 x = (7 - 5) / 4 = 2 / 4 = 1/2",
        ...
        steps: [
          {
            title: "문제 이해하기",
            content:
              "이 문제는 함수 f(x) = x³ - 3x² + 2의 도함수 f'(x)를 구하는 문제입니다.",
            hint: "도함수는 함수의 순간 변화율을 나타내며, 미분을 통해 구할 수 있습니다.",
          },
          {
            title: "미분 법칙 적용하기",
            content:
              "각 항을 개별적으로 미분한 후 더합니다. 다항함수의 미분 공식을 사용합니다.",
        ...
        steps: [
          {
            title: "문제 이해하기",
            content:
              "이 문제는 함수 2x + 3의 부정적분 ∫(2x + 3)dx를 구하는 문제입니다.",
            hint: "부정적분은 미분의 역과정으로, 주어진 함수를 미분하면 원래 함수가 나오는 함수를 찾는 것입니다.",
          },
          {
            title: "적분 법칙 적용하기",
            content:
              "각 항을 개별적으로 적분한 후 더합니다. 다항함수의 적분 공식을 사용합니다.",
        ...
        steps: [
          {
            title: "문제 이해하기",
            content:
              "이 문제는 삼각함수의 기본 항등식 sin²θ + cos²θ = 1을 증명하는 문제입니다.",
            hint: "삼각함수의 기본 정의와 피타고라스 정리를 활용할 수 있습니다.",
          },
          {
            title: "접근 방법 선택하기",
            content:
              "단위원(반지름이 1인 원)에서 삼각함수의 정의를 활용하여 증명해 보겠습니다.",
            hint: "단위원에서 점 (cosθ, sinθ)는 원 위의 점입니다.",
          },
          {
            title: "단위원 적용하기",
            content:
              "단위원에서 점 (x, y) = (cosθ, sinθ)는 원 위의 점입니다. 단위원의 방정식은 x² + y² = 1입니다.",
            hint: "단위원은 원점을 중심으로 하고 반지름이 1인 원입니다.",
          },
          {
            title: "대입하기",
            content:
              "x = cosθ, y = sinθ를 단위원 방정식 x² + y² = 1에 대입하면, cos²θ + sin²θ = 1이 됩니다.",
  ...
  const handleProblemRecognized = (text: string) => {
    ...
    const problemsOfType =
      exampleProblems[detectedType as keyof typeof exampleProblems] || [];
    const selectedProblem =
      problemsOfType.find((p) => p.difficulty === difficulty) ||
      problemsOfType[0];
  ...
  const handleTopicSelect = (topic: string) => {
    ...
    const problemsOfType =
      exampleProblems[topic as keyof typeof exampleProblems];
  ...
  const handleDifficultyChange = (value: string) => {
    ...
    if (problemType) {
      const problemsOfType =
        exampleProblems[problemType as keyof typeof exampleProblems];
      if (problemsOfType && problemsOfType.length > 0) {
        const selectedProblem =
          problemsOfType.find((p) => p.difficulty === value) ||
          problemsOfType[0];
        setProblemText(selectedProblem.text);
        setSolutionSteps(selectedProblem.steps);
        setCurrentStep(0);
  ...
  return (
    <div className="space-y-6">
      ...
      <Tabs defaultValue="upload" className="w-full">
        ...
        <TabsContent value="upload" className="mt-0"></TabsContent>
