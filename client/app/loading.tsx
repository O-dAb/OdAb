          ...
          <div className="text-center space-y-6">
            <div className="flex justify-center">
              <div className="relative">
                <BrainCircuit className="h-20 w-20 text-purple-500 animate-pulse" />
                <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 text-xs font-medium text-purple-700">
                  {progress}%
                </div>
              </div>
            </div>
            <h1 className="text-2xl font-bold text-gray-800">수학 도우미 로딩 중...</h1>
            <p className="text-gray-600">학습 데이터를 불러오고 있습니다.</p>
          ...
          <Card className="border-purple-200 shadow-lg">
            ...
            <CardFooter className="flex flex-col gap-3">
              {isLoggedIn ? (
                ...
                <>
                  <Button className="w-full bg-purple-500 hover:bg-purple-600" onClick={() => router.push("/login")}>
                    로그인
                  </Button>
