        ...
        <Card className="border-0 shadow-xl rounded-2xl bg-gradient-to-r from-blue-50 via-purple-50 to-blue-100 dark:from-gray-800 dark:via-gray-700 dark:to-gray-800">
          ...
          <CardContent className="pt-6">
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                {recentStudy ? (
                  <div className="p-3 bg-blue-50/80 dark:bg-gray-700/50 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                    <div className="text-blue-700 dark:text-blue-200">
                      {recentStudy.subConceptType}
                    </div>
                    <div className="text-xs text-gray-500 dark:text-gray-300">
                      마지막 학습일: {formatDate(recentStudy.lastLearningTime)}
                      console.console.log(formatDate(recentStudy.lastLearningTime));
                      
                    </div>
                  </div>
                ) : (
                  <div className="text-center py-4 text-gray-500 dark:text-gray-300 bg-blue-50/50 dark:bg-gray-700/30 rounded-xl">
                    최근 학습 기록이 없습니다.
                  </div>
                )}
              </div>
          ...
          <CardFooter className="pt-2 pb-6">
            <Link href="/solve" className="w-full">
              <Button className="w-full bg-blue-400 hover:bg-blue-500 dark:bg-blue-500 dark:hover:bg-blue-400 rounded-xl font-medium shadow-sm">
                문제 풀기
              </Button>
            </Link>
          </CardFooter>
